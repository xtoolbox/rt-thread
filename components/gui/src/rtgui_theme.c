...
const rtgui_color_t default_foreground_rtgui_system_defined = RTGUI_RGB(0x00, 0x00, 0x00);
const rtgui_color_t default_background_rtgui_system_defined = RTGUI_RGB(212, 208, 200);
...
/* window drawing */
void rtgui_theme_draw_win_window_did_this(struct rtgui_wintitle *wint)
{
    struct rtgui_dc *dc;
